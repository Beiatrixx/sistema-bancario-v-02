# OBJETIVOS:
    # Separar as operações existentes em funções:
        ...
        # Função visualizar extrato
            # positional only + keyword only (híbrida)
            # argumentos posicionais: saldo
            # argumentos nomeados: extrato
    # Criar 2 novas funções:
        # Cadastrar usuário (cliente)
            # armazenar usuários em uma lista (chave: valor)
            # usuário = nome, data de nascimento, cpf e endereço (str com: logradouro, nro - bairro - cidade/sigla estado)
            # armazenar somente os números do CPF (ignorar pontos e traços)
            # bloquear cadastro de 2 usuários com o mesmo CPF
        # Cadastrar conta bancária (vinculada ao usuario)
            ...
            # usuário pode ter mais de 1 conta, mas a conta pertence a um único usuário
            # não existe conta sem usuário
            # DICA!!! Vincular usuário a uma conta --> filtrar a lista de usuários buscando o número do CPF informado para cada usuário da lista
    # Opcional: adicionar função listar contas, listar usuários, inativar conta, etc.
